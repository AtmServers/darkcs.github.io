...
if(isset($_POST['create_dialog'])){
	...
	if(!check_to_friend($pdo, $id)) {
		?>
		<script>show_input_error('text','Данному пользователю могут писать только друзья. &nbsp&nbsp&nbsp', 99999);</script>
		<?php
	}
	...
	if(empty($row->id)){
		...
		?>
		<script>open_dialog(<?php echo $row->id ?>);</script>
		<?php
	}
}
